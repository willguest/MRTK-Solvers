...
/// <summary>
/// RemoveSurfaceVertices will remove any vertices from an object's mesh that fall within the bounding volume.
/// This can be used to create holes in objects (such as the processed mesh), or to help reduce triangle count after setting planes.
/// </summary>
public class RemoveObjectVertices : Singleton<RemoveObjectVertices>
{
    ...
    /// /// <param name="meshToEdit">List of mesh filters describing the object from which vertices will be removed</param>
    public void RemoveVerticesWithinBounds(IEnumerable<GameObject> boundingObjects, List<MeshFilter> meshToEdit)
    {
        ...
        if (!removingVerts)
        {
            ...
            StartCoroutine(RemoveVerticesWithinBoundsRoutine(meshToEdit));
        }
        else
        {
    ...
    private IEnumerator RemoveVerticesWithinBoundsRoutine(List<MeshFilter> meshFilters)
    {
